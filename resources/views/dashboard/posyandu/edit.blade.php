            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="card">
                    <div class="card-body py-4">
                        ...
                        <form class="form" action="{{ url('data/posyandu/update/'.$data->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                            <div class="fv-row mb-7">
                                <label class="fs-6 fw-bold form-label mt-3">
                                    <span class="required">Nama Pos</span>
                                    <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                        title="Nama Pos."></i>
                                </label>
                                <input type="text" required class="form-control form-control-solid" name="nama_pos"
                                    value="{{$data->nama_pos}}" placeholder="Cth : Pos Klobuk Wetan" />
                            </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" required class="form-control form-control-solid" name="desa"
                                    value="{{$data->desa}}" placeholder="Cth : Klobuk Wetan" />
                            </div>

                             <div class="fv-row mb-7">
                                <label class="fs-6 fw-bold form-label mt-3">
                                    <span class="required">Alamat Pos</span>
                                    <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                        title="Alamat Pos"></i>
                                </label>
