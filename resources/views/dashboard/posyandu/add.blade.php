            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="card">
                    <div class="card-body py-4">
                        ...
                        <form class="form" action="{{ url('data/posyandu/store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" required class="form-control form-control-solid" name="nama_pos"
                                    value="" placeholder="Cth : Pos Klobuk Wetan" />
                            </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" required class="form-control form-control-solid" name="desa"
                                    value="" placeholder="Cth : Klobuk Wetan" />
                            </div>
