        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <div class="card">
                        ...
                        <div class="card-title">
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-user-table-filter="search"
                                    class="form-control form-control-solid w-250px ps-14" placeholder="Cari Nama Kapus" />
                            </div>
                        </div>
                        @if(Auth::user()->role == 'ahli_gizi')
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a href="{{ url('/user/kapus/create') }}" class="btn btn-primary">
                    ...
                    <div align="right">
                        <a class="btn btn-success" href="{{url('user/kapus/export')}}">
                                Export Data Kapus &nbsp;<i class="fa fa-file-excel"></i>
                        </a>
                    </div>
                    @endif
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ url('user/kapus/edit/' . $item->id) }}"
                                                        class="menu-link px-3"
                                                        data-kt-users-table-filter="edit_row">Edit</a>
                                                </div>
                                                <div class="menu-item px-3">
                                                    <a href="{{ url('user/kapus/delete/' . $item->id) }}"
