...
@section('content')
    <div class="col-xl-12">
        ...
        <!--begin::Contacts-->
        <form class="form" action="{{ url('/layanan/customer_service_submission_update/' . $data->id) }}" method="post"
            ...
            <div class="card card-flush h-lg-100" id="kt_contacts_main">
                ...
                <div class="card-body pt-12">
                    ...
                    <div class="row fv-row mb-7">
                        ...
                        <div class="w-50">
                            ...
                            <select class="form-select form-select-solid" required name="type"
                                data-kt-ecommerce-settings-type="select2_flags" data-placeholder="Pilih Jenis" onchange="showHideBasedOnChoosetipe(this.value)">
                                <option value="" selected disabled="">Pilih tipe</option>
                                <option value="personal"{{ $data->customer->type == 'personal' ? 'selected' : '' }}>
                                    Personal
                                </option>
                    ...
                    <div class="row fv-row mb-7">
                        ...
                        <div class="col-md-6">
                            <!--begin::Input-->
                            <input type="Nama" required placeholder="Masukkan Nama Yang Sesuai"
                    ...
                    <div class="row fv-row mb-7">
                        ...
                        <div class="col-md-6">
                            <!--begin::Input-->
                            <input type="Alamat" required placeholder="Masukkan Alamat Yang Sesuai"
                    ...
                    <div class="row fv-row mb-7">
                        ...
                        <div class="col-md-6">
                            <!--begin::Input-->
                            <input type="text" onkeypress="return hanyaAngka(event)" required
                    ...
                    <div class="row fv-row mb-7">
                        ...
                        <div class="col-md-6">
                            <!--begin::Input-->
                            <input type="email" onblur="validateEmail(this);" required placeholder="Masukkan Email "
                    ...
                    <div class="row fv-row mb-7" id="perusahaan"
                        ...
                        <div class="col-md-6">
                            <!--begin::Input-->
                            <input type="text" id="perusahaan_value" required placeholder="Masukkan Nama Perusahaan Anda"
                                class="form-control form-control-solid" name="company_name"
                                value="{{ $data->customer->company_name }}" id="nama_perusahaan" />
                            <!--end::Input-->
                        </div>
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row fv-row mb-7">
                        ...
                        <div class="w-50">
                            ...
                            <select class="form-select form-select-solid" required name="income_per_month"
                                ...
                                <option value="" selected disabled="">Pilih Jumlah Pendapatan</option>
                                <option
                ...
                <div class="row fv-row mb-7">
                    ...
                    <div class="w-50">
                        ...
                        <select class="form-select form-select-solid" required name="service"
                            ...
                            <option value="komplain"{{ $data->service == 'komplain' ? 'selected' : '' }}>komplain</option>
                            <option
                                value="administrasi_daftar_bank_hitam"{{ $data->service == 'administrasi_daftar_bank_hitam' ? 'selected' : '' }}>
                                Administrasi Daftar Bank Hitam</option>
                            <option
                                value="administrasi_daftar_rehabilitasi_nasabah"{{ $data->service == 'administrasi_daftar_rehabilitasi_nasabah' ? 'selected' : '' }}>
                                Administrasi Daftar Rehabilitasi Nasabah</option>
                            <option
                                value="administrasi_buku_cek"{{ $data->service == 'administrasi_buku_cek' ? 'selected' : '' }}>
                                Administrasi Buku Cek</option>
                            <option
                                value="administrasi_bilyet_giro"{{ $data->service == 'administrasi_bilyet_giro' ? 'selected' : '' }}>
                                Administrasi Bilyet Giro</option>
                            <option
                                value="administrasi_buku_tabungan"{{ $data->service == 'administrasi_buku_tabungan' ? 'selected' : '' }}>
                                Administrasi Buku Tabungan</option>
                            <option
                                value="administrasi_resi_permintaan_pengembalian_buku_cek"{{ $data->service == 'administrasi_resi_permintaan_pengembalian_buku_cek' ? 'selected' : '' }}>
                                Administrasi Resi Permintaan Pengembalian Buku Cek</option>
                            <option
                                value="administrasi_resi_permintaan_pengembalian_bilyet_giro"{{ $data->service == 'administrasi_resi_permintaan_pengembalian_bilyet_giro' ? 'selected' : '' }}>
                                Administrasi Resi Permintaan Pengembalian Bilyet Giro</option>
                            <option
                                value="administrasi_resi_permintaan_pengembalian_surat_kuasa"{{ $data->service == 'administrasi_resi_permintaan_pengembalian_surat_kuasa' ? 'selected' : '' }}>
                                Administrasi Resi Permintaan Pengembalian Surat Kuasa</option>
                            <option
                                value="info_saldo_dan_mutasi_nasabah"{{ $data->service == 'info_saldo_dan_mutasi_nasabah' ? 'selected' : '' }}>
                                Info Saldo dan Mutasi Nasabah</option>
                        </select>
                        <!--end::Select2-->
                    </div>
                </div>
                ...
                <div class="row fv-row mb-7">
                    ...
                    <div class="row">
                        <div class="col-md-9 offset-md-3">
                            ...
                            <!--end::Separator-->
                            <div class="d-flex justify-content-center">
                                <a href="{{ url('/layanan/customer_service_submission_index') }}" class="btn btn-danger"
