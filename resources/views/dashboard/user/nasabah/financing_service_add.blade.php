...
@section('content')
    <style>
        #text1::-webkit-select-data-placeholder::after {
    ...
    <div class="col-xl-12">
        ...
        <!--begin::Contacts-->
        <form class="form" action="{{ url('/layanan/financing_service_submission_store') }}" method="post"
            ...
            <div class="card card-flush h-lg-100" id="kt_contacts_main">
                ...
                <div class="card-body pt-12">
                    ...
                    <div class="row fv-row mb-7">
                        ...
                        <div class="w-50">
                            <!--begin::Select2-->
                            <select class="form-select form-select-solid" required name="category" id='text1'
                    ...
                    <div class="row fv-row mb-7">
                        ...
                        <div class="w-50">
                            <!--begin::Select2-->
                            <select required class="form-select form-select-solid" name="income_per_month"
                ...
                <div class="row fv-row mb-7">
                    ...
                    <div class="w-50">
                        ...
                        <select class="form-select form-select-solid" required name="service"
                            ...
                            <option value="multimanfaat">Multimanfaat</option>
                            <option value="multiguna">Multiguna</option>
                            <option value="modal_kerja_commercial">Modal Kerja Komersial</option>
                        </select>
                        <!--end::Select2-->
                    </div>
                </div>
