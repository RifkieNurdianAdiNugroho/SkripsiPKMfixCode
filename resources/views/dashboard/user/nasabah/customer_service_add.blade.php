...
@section('content')
    <div class="col-xl-12">
        ...
        <!--begin::Contacts-->
        <form class="form" action="{{ url('/layanan/customer_service_submission_store') }}" method="post"
            ...
            <div class="card card-flush h-lg-100" id="kt_contacts_main">
                ...
                <div class="card-body pt-12">
                    ...
                    <div class="row fv-row mb-7">
                        ...
                        <div class="w-50">
                            <!--begin::Select2-->
                            <select required class="form-select form-select-solid" name="category"
                    ...
                    <div class="row fv-row mb-7">
                        ...
                        <div class="w-50">
                            <!--begin::Select2-->
                            <select required class="form-select form-select-solid" name="type"
                                data-kt-ecommerce-settings-type="select2_flags" data-placeholder="Pilih Jenis"
                    ...
                    <div class="row fv-row mb-7">
                        ...
                        <div class="w-50">
                            <!--begin::Select2-->
                            <select required class="form-select form-select-solid" name="profession"
                                data-kt-ecommerce-settings-type="select2_flags" data-placeholder="Pilih Jenis">
                    ...
                    <div class="row fv-row mb-7" id="perusahaan">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="perusahaan_value" required placeholder="Masukkan Nama Perusahaan Anda"
                                class="form-control form-control-solid" name="company_name" value="" />
                            <!--end::Input-->
                        </div>
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row fv-row mb-7" id="jabatan">
                        ...
                        <div class="w-50">
                            <!--begin::Select2-->
                            <select required id="jabatan_value" class="form-select form-select-solid" name="position"
                    ...
                    <div class="row fv-row mb-7">
                        ...
                        <div class="w-50">
                            <!--begin::Select2-->
                            <select class="form-select form-select-solid" name="income_per_month"
                ...
                <div class="row fv-row mb-7">
                    ...
                    <div class="w-50">
                        ...
                        <select class="form-select form-select-solid" required name="service"
                            ...
                            <option value="administrasi_daftar_bank_hitam">Administrasi Daftar Bank Hitam</option>
                            <option value="administrasi_daftar_rehabilitasi_nasabah">Administrasi Daftar Rehabilitasi
                                Nasabah</option>
                            <option value="administrasi_buku_cek">Administrasi Buku Cek</option>
                            <option value="administrasi_bilyet_giro">Administrasi Bilyet Giro</option>
                            <option value="administrasi_buku_tabungan">Administrasi Buku Tabungan</option>
                            <option value="administrasi_resi_permintaan_pengembalian_buku_cek">Administrasi Resi Permintaan
                                Pengembalian Buku Cek</option>
                            <option value="administrasi_resi_permintaan_pengembalian_bilyet_giro">Administrasi Resi
                                Permintaan Pengembalian Bilyet Giro</option>
                            <option value="administrasi_resi_permintaan_pengembalian_surat_kuasa">Administrasi Resi
                                Permintaan Pengembalian Surat Kuasa</option>
                            <option value="info_saldo_dan_mutasi_nasabah">Info Saldo dan Mutasi Nasabah</option>
                        </select>
                        <!--end::Select2-->
                    </div>
                </div>
