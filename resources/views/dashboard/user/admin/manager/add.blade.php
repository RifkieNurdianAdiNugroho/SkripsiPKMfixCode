    ...
    <div class="col-xl-12">
        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body pt-5">
                <!--begin::Form-->
                <form class="form" action="{{ url('user/manager_store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Input group-->
                    <div class="mb-7">
                        <!--begin::Label-->
                        ...
                        <div class="mt-1">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                ...
                                <span class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                    data-kt-image-input-action="cancel" id="cancel_photo" data-bs-toggle="tooltip" title="Cancel avatar">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="email" onblur="validateEmail(this);" required
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <label class="fs-6 fw-bold form-label mt-3">
                                    ...
                                    <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                        title="Masukkan Nomor Anda"></i>
                                </label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" onkeypress="return hanyaAngka(event)" required
                                    class="form-control form-control-solid" name="phone" value="" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                        </div>
...
@section('scriptcustom')
    ...
    <script>
        ...
        function removeAavatar()
        {
            $('#cancel_photo').trigger("click");
        }
    </script>
@endsection
